...
public class Chunk : MonoBehaviour
{
    ...
    struct CalculateBlockTypes : IJobParallelFor
    {
        ...
        public int height;
        public Vector3 location;
        public NativeArray<Unity.Mathematics.Random> randoms { get; set; }
        ...
        public void Execute(int i)
        {
            ...
            int diamondTopHeight = (int)MeshUtils.fBM(x, z, World.diamondTopSettings.octaves, World.diamondTopSettings.scale, World.diamondTopSettings.heightScale, World.diamondTopSettings.heightOffset);
            int diamondBottomHeight = (int)MeshUtils.fBM(x, z, World.diamondBottomSettings.octaves, World.diamondBottomSettings.scale, World.diamondBottomSettings.heightScale, World.diamondBottomSettings.heightOffset);
    ...
    void BuildChunk()
    {
        ...
        var RandomArray = new NativeArray<Unity.Mathematics.Random>(randomArray, Allocator.Persistent);
